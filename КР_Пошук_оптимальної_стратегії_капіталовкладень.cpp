...
void run_dynamic_programming(float** start_table, int rows, int cols, float resource, int correlation); // Прототип функції, необхідної для реалізації методу динамічного програмування
...
int main() // Головна функція програми
{
    ...
    while (true)
    {
        ...
        if (choice == 1)
        {
            ...
            {
				run_dynamic_programming(start_table, rows, cols, resource, correlation); // Виклик функції, що реалізує метод динамічного програмування
            }
...
void run_dynamic_programming(float** start_table, int rows, int cols, float resource, int correlation) // Визначення функції, необхідної для реалізації методу динамічного програмування
{
